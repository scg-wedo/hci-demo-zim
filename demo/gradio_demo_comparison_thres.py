...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():   
            with gr.Tab(label="ZIM Threshold Mask"):
                zim_mask_thresh = gr.Image(label="Threshold ZIM Mask")
            with gr.Tab(label="ZIM Masked Image"):
                masked_img = gr.Image(label="ZIM Masked Image")
        ...
        apply_thresh_btn.click(
            ...
            outputs=[zim_mask_thresh, masked_img]
        )
